...
* [Android-Show-Taps](https://play.google.com/store/apps/details?id=show.taps) - Show customized taps upon touches `GPL-3.0` [(Source code)](https://github.com/k3x1n/Android-Show-Taps)
